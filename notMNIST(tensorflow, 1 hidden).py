...
# @Last Modified time: 2017-02-21 20:55:18
...
with graph.as_default():
	...
	input_layer_regularization = beta[0] * tf.nn.l2_loss(weights[0])
	hidden_layer_regularization = beta[1] * tf.nn.l2_loss(weights[1]) 
	loss = tf.reduce_mean(cross_entropy + input_layer_regularization + hidden_layer_regularization)
